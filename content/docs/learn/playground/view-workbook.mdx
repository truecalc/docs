...
#### A literal number renders with no explicit alignment override (right-aligned by the type-based default)
...
#### A literal text value renders with no explicit alignment override (left-aligned by the type-based default)
