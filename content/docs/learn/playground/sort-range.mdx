...
#### Data ▸ Create a filter is still disabled — this slice ships sort only

**Given**

**When** I click menu item **data.createFilter**

**Then**
- `[data-menu-item="data.createFilter"]` is visible
