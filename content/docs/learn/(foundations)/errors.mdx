---
title: Error codes
description: The spreadsheet error values — what causes each one, how errors propagate through formulas, and how to catch or inspect them.
---
...
You may also meet `#ERROR!` in the Google Sheets UI — its on-screen marker
